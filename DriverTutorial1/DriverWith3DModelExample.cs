...
namespace UKRobotics.DriverTutorial1
{
    ...
    /// <summary>
    /// This driver will load the 3d OBJ file from the given relative path in the ModelFileAttribute. Note that model files are held in a directory tree in the installation folder "models".
    /// 
    /// 
    /// </summary>
